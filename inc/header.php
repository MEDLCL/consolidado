    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="#" class="logo">
                ...
                <span class="logo-mini"><img src="../img/logo2.jfif" alt="logo" height="50px"> </span>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs">Manuel de la Cruz</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    <img src="../plantilla/dist/img/user2-160x160.jpg" class="img-circle"
                                        alt="User Image">
                                    <p>
                                        Manuel de la cruz desarrollador aprendis
                                        <small>Comienzo 2020</small>
                                    </p>
                                </li>
                            </ul>
                        </li>
