            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h2>Sucursales</h2>
                        <button class="btn btn-primary" onclick="limpiar()" data-toggle="modal"
                            data-target="#modalsucursal" id="Nsucursal">Agregar Nuevo
                            <span class="glyphicon glyphicon-plus"></span>
                        </button>
                        <div class="box-tools pull-right"></div>
                    </div><!-- /.box-header -->
                    <div class="panel-body table-responsive">
                        <table id="listadosucursal" name="listadosucursal"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="" method="post" id="formsucursal"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="input-control selectpicker " data-live-search="true" name="pais"
                                        id="pais">
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <img src="" alt="" id="logo_muestra" name="logo_muestra" width="150px"
                                        height="120px">
                                </div>
                            </div>
                            <div class="form-group">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="actualizadatos"
                    onclick="editarinsertar()">Grabar</button>
            </div>
        </div>
    </div>
</div>
